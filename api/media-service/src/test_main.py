...
class TestFileUpload:
    ...
    def test_upload_png_image(self, client, sample_png_image):
        ...
        response = client.post(
            "/api/v1/media/upload",
            data={"file": (sample_png_image, "test.png")},
        )
    ...
    def test_upload_empty_filename(self, client):
        ...
        response = client.post(
            "/api/v1/media/upload", data={"file": (BytesIO(b""), "")}
        )
...
class TestImageResize:
    ...
    def test_resize_missing_filename(self, client):
        ...
        resize_data = {"width": 50, "height": 50}
        response = client.post("/api/v1/media/resize", json=resize_data)
    ...
    def test_resize_missing_dimensions(self, client):
        ...
        resize_data = {"filename": "test.jpg", "width": 50}
        response = client.post("/api/v1/media/resize", json=resize_data)
    ...
    def test_resize_negative_dimensions(self, client):
        ...
        resize_data = {"filename": "test.jpg", "width": -50, "height": 50}
        response = client.post("/api/v1/media/resize", json=resize_data)
    ...
    def test_resize_oversized_dimensions(self, client):
        ...
        resize_data = {"filename": "test.jpg", "width": 5000, "height": 5000}
        response = client.post("/api/v1/media/resize", json=resize_data)
...
class TestIntegration:
    ...
    def test_complete_workflow(self, client, sample_image):
        ...
        upload_response = client.post(
            "/api/v1/media/upload",
            data={"file": (sample_image, "workflow_test.jpg")},
        )
        ...
        # 3. Resize
        resize_data = {"filename": filename, "width": 75, "height": 75}
        ...
        # 6. Delete resized
        delete_resized_response = client.delete(
            f"/api/v1/media/delete/{resized_filename}"
        )
...
import pytest
from main import UPLOAD_FOLDER, app
from PIL import Image
...
class TestFileUpload:
    ...
    def test_upload_png_image(self, client, sample_png_image):
        """Test uploading a PNG image"""
        response = client.post(
            "/api/v1/media/upload", data={"file": (sample_png_image, "test.png")}
        )
...
class TestImageResize:
    ...
    def test_resize_invalid_dimensions(self, client):
        """Test resize with invalid dimensions"""
        resize_data = {"filename": "test.jpg", "width": "invalid", "height": 50}
        response = client.post("/api/v1/media/resize", json=resize_data)
    ...
    def test_resize_nonexistent_file(self, client):
        """Test resizing a non-existent file"""
        resize_data = {"filename": "nonexistent.jpg", "width": 50, "height": 50}
        response = client.post("/api/v1/media/resize", json=resize_data)
...
class TestIntegration:
    ...
    def test_complete_workflow(self, client, sample_image):
        ...
        # 1. Upload
        upload_response = client.post(
            "/api/v1/media/upload", data={"file": (sample_image, "workflow_test.jpg")}
        )
        assert upload_response.status_code == 200
        upload_data = upload_response.get_json()
        filename = upload_data["data"]["filename"]
